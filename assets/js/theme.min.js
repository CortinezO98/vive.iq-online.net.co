...
! function() {
	if ($(".dropdown-menu a.dropdown-toggle").length && $(".dropdown-menu a.dropdown-toggle").on("click", (function(e) {
			...
			if ($("#main-wrapper").hasClass("toggled")) {
				localStorage.setItem("menu_status", "toggled");
			} else {
				localStorage.setItem("menu_status", "");
			}
	...
	if ($("#checkAll").length && $("#checkAll").on("click", (function() {
		...
		})), $("#do").length && dragula([document.querySelector("#do"), document.querySelector("#progress"), document.querySelector("#review"), document.querySelector("#done")]), $("#invoice").length && $("#invoice").find(".print-link").on("click", (function() {
			$.print("#invoice")
		...
		t && t.addEventListener("click", (function() {
			var t, n, o;
			t = "Nice, you triggered this alert message!", n = "success", (o = document.createElement("div")).innerHTML = '<div class="alert alert-' + n + ' alert-dismissible" role="alert">' + t + '<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>', e.append(o)
		}))
	}
...
function valida_menu() {
	let status = localStorage.getItem("menu_status");
	// alert(status);
	if (status=='toggled') {
