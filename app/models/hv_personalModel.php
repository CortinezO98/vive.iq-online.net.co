<?php
    class hv_personalModel extends Model {
        ...
        public $hvp_autorizacion_texto_id;
        ...
        public $hvp_poblacion_vulnerable;
        ...
        public $hvp_sagrilaft_texto_id;
        public $hvp_sagrilaft_fecha;
        ...
        public $hvp_alerta_financiera;
        public $hvp_alerta_familiaridad;
        ...
        public function list(){
            ...
            if ($this->hvp_alerta_financiera!="" AND $this->hvp_alerta_financiera!="null") {
                $filtro_alerta_financiera_str=" AND `hvp_alerta_financiera`=:hvp_alerta_financiera";
                $parametros_filtro = [
                    'hvp_alerta_financiera' => $this->hvp_alerta_financiera,
                ];
                $parametros = array_merge($parametros, $parametros_filtro);
            } else {
                $filtro_alerta_financiera_str="";
            }

            if ($this->hvp_alerta_familiaridad!="" AND $this->hvp_alerta_familiaridad!="null") {
                $filtro_alerta_familiaridad_str=" AND `hvp_alerta_familiaridad`=:hvp_alerta_familiaridad";
                $parametros_filtro = [
                    'hvp_alerta_familiaridad' => $this->hvp_alerta_familiaridad,
                ];
                $parametros = array_merge($parametros, $parametros_filtro);
            } else {
                $filtro_alerta_familiaridad_str="";
            }
            ...
            LEFT JOIN `'.DB_NAME_AUX.'`.`administrador_cargos` AS TCAR ON `hoja_vida_personal`.`hvp_cargo`=TCAR.`ac_id` LEFT JOIN `'.DB_NAME_AUX.'`.`administrador_areas` AS TCC ON `hoja_vida_personal`.`hvp_centro_costo`=TCC.`aa_id`
             WHERE 1=1 '.$filtro_bandeja_str.' '.$filtro_documento_nuevo_str.' '.$filtro_alerta_financiera_str.' '.$filtro_alerta_familiaridad_str.' '.$filtro_str.' ORDER BY `hvp_datos_personales_nombre_1`, `hvp_datos_personales_nombre_2`, `hvp_datos_personales_apellido_1`, `hvp_datos_personales_apellido_2` LIMIT :offset,:limite';
        ...
        public function listCount(){
            ...
            LEFT JOIN `app_ciudades_barrios` AS TBARRIO ON `hoja_vida_personal`.`hvp_ubicacion_barrio`=TBARRIO.`ciub_id`
            LEFT JOIN `'.DB_NAME_AUX.'`.`administrador_cargos` AS TCAR ON `hoja_vida_personal`.`hvp_cargo`=TCAR.`ac_id` LEFT JOIN `'.DB_NAME_AUX.'`.`administrador_areas` AS TCC ON `hoja_vida_personal`.`hvp_centro_costo`=TCC.`aa_id`
             WHERE 1=1 '.$filtro_bandeja_str.' '.$filtro_documento_nuevo_str.' '.$filtro_alerta_financiera_str.' '.$filtro_alerta_familiaridad_str.' '.$filtro_str.' ORDER BY `hvp_datos_personales_nombre_1`, `hvp_datos_personales_nombre_2`, `hvp_datos_personales_apellido_1`, `hvp_datos_personales_apellido_2`';
        ...
        public function listAutorizacion(){
            $sql='SELECT `hvp_consentimiento_tratamiento_datos_personales`, `hvp_consentimiento_tratamiento_datos_personales_fecha`, `hvp_autorizacion_texto_id`, `hvp_firma`, `hvp_origen_fondos`, `hvp_sagrilaft_texto_id`, `hvp_sagrilaft_fecha` FROM `hoja_vida_personal` WHERE `hvp_usuario_id`=:hvp_usuario_id';
        ...
        public function add(){
            ...
            $parametros = [
                ...
                'hvp_poblacion_vulnerable' => $this->hvp_poblacion_vulnerable,
        ...
        public function updateAutorizacionVersion(){
            $sql='UPDATE `hoja_vida_personal` SET `hvp_autorizacion_texto_id`=:hvp_autorizacion_texto_id WHERE `hvp_usuario_id`=:hvp_usuario_id';

            $parametros = [
                'hvp_usuario_id' => $this->hvp_usuario_id,
                'hvp_autorizacion_texto_id' => $this->hvp_autorizacion_texto_id,
            ];
        ...
        public function updateSagrilaftVersion(){
            $sql='UPDATE `hoja_vida_personal` SET `hvp_sagrilaft_texto_id`=:hvp_sagrilaft_texto_id, `hvp_sagrilaft_fecha`=:hvp_sagrilaft_fecha WHERE `hvp_usuario_id`=:hvp_usuario_id';

            $parametros = [
                'hvp_usuario_id' => $this->hvp_usuario_id,
                'hvp_sagrilaft_texto_id' => $this->hvp_sagrilaft_texto_id,
                'hvp_sagrilaft_fecha' => $this->hvp_sagrilaft_fecha,
            ];
        ...
        public function updateOrigenFondos(){
            $sql='UPDATE `hoja_vida_personal` SET `hvp_origen_fondos`=:hvp_origen_fondos, `hvp_actualiza_fecha`=:hvp_actualiza_fecha WHERE `hvp_usuario_id`=:hvp_usuario_id';
        ...
        public function updateAlertaFinanciera(){
            $sql='UPDATE `hoja_vida_personal` SET `hvp_alerta_financiera`=:hvp_alerta_financiera WHERE `hvp_usuario_id`=:hvp_usuario_id';
        ...
        public function updateAlertaFamiliaridad(){
            $sql='UPDATE `hoja_vida_personal` SET `hvp_alerta_familiaridad`=:hvp_alerta_familiaridad WHERE `hvp_usuario_id`=:hvp_usuario_id';
