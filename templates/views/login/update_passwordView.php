                ...
                <div class="card-body p-6">
                    ...
                    <form name="form_recovery" method="post" action="">
                        ...
                        <?php if($data['control_login']): ?>
                            <?php if($_SESSION[APP_SESSION.'_update_registro_creado']!=1): ?>
                                ...
                                <p class="appoinment-content-text my-0">Ingresa la nueva contraseña</p>
                                <div class="col-md-12 my-2">
                                    <div class="form-group">
                                        <input type="password" name="password_1" id="password" class="form-control" minlenght="8" maxlenght="15" value="<?php echo (isset($_POST["password_1"])) ? checkInput($_POST['password_1']) : ''; ?>" placeholder="Contraseña" <?php echo ($_SESSION[APP_SESSION.'_update_registro_creado']==1) ? 'disabled' : ''; ?>  onkeyup="getPassword();" required>
                                    </div>    
                                </div>
                                <p class="appoinment-content-text my-0">Confirmar contraseña</p>
                                <div class="col-md-12 my-2">
                                    <div class="form-group">
                                        <input type="password" name="password_2" id="password_2" class="form-control" minlenght="8" maxlenght="15" value="<?php echo (isset($_POST["password_2"])) ? checkInput($_POST['password_2']) : ''; ?>" placeholder="Contraseña" <?php echo ($_SESSION[APP_SESSION.'_update_registro_creado']==1) ? 'disabled' : ''; ?> required>
                                    </div>    
                                </div>
                        ...
                        <div>
                            <!-- Button -->
                            <div class="d-grid">
                                <?php if($data['control_login_sesion']): ?>
                                    <!-- <a href="<?php echo URL; ?>inicio" class="btn btn-success mt-1">Continuar</a> -->
                                <?php endif; ?>
                                <?php if($_SESSION[APP_SESSION.'_update_registro_creado']==1 OR !$data['control_login']): ?>
