                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            <div class="row p-6 d-lg-flex justify-content-between align-items-center">
                                ...
                                <div class="col-md-12 px-5">
                                    ...
                                    <a href="<?php echo URL; ?>seleccion-vinculacion/formulario-autorizaciones<?php echo $data['path_add']; ?>" class="btn btn-dark px-2 font-size-11 py-1 text-start mt-1 d-block">Declaraciones<span id="status_autorizaciones"></span></a>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row mb-2">
                                            ...
                                            <?php if($data['valida_token']): ?>
                                                ...
                                                <div class="col-md-12 my-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="Si" name="hvada_origen_fondos" id="hvada_origen_fondos" <?php echo ($data['resultado_registros'][0]->hvada_origen_fondos=='Si') ? 'checked' : ''; ?> required>
                                                        <label class="form-check-label font-size-12 fw-bold" for="hvada_origen_fondos">Si, acepto</label>
                                                    </div>
                                                </div>
                                                <?php endif; ?>
                                            <?php else: ?>
        ...
        if (token!="" && id_oferta!="") {
            $.ajax({
                ...
                success: function(data){
                    ...
                    if (resp.secciones.autorizaciones==1) {
                        $('#btn_continuar').html('<a href="<?php echo URL; ?>seleccion-vinculacion/formulario-autorizaciones-datos<?php echo $data['path_add']; ?>" class="btn btn-dark login-btn">Continuar</a>');
                    }
