                                            ...
                                            <div class="col-md-12">
                                                <div class="row mb-2">
                                                    <div class="col-md-4 mb-1">
                                                        <label for="hvao_estado" class="form-label my-0 font-size-11">Estado vinculación</label>
                                                        <select class="form-select form-select-sm" name="hvao_estado" id="hvao_estado" required>
                                                            <option value=""></option>
                                                            <option value="Vinculado" <?php echo ($data['resultado_registros_ofertas'][0]->hvao_estado=='Vinculado') ? 'selected' : ''; ?>>Vinculado</option>
                                                            <option value="No vinculado" <?php echo ($data['resultado_registros_ofertas'][0]->hvao_estado=='No vinculado') ? 'selected' : ''; ?>>No vinculado</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
