                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            <div class="row p-6 d-lg-flex justify-content-between align-items-center">
                                ...
                                <div class="col-md-12 px-5">
                                    ...
                                    <a href="<?php echo URL; ?>seleccion-vinculacion/formulario-segsocial<?php echo $data['path_add']; ?>" class="btn btn-dark px-2 font-size-11 py-1 text-start mt-1 d-block">Seguridad Social<span id="status_segsocial"></span></a>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row mb-2">
                                            ...
                                            <?php if($data['valida_token']): ?>
                                                ...
                                                <p class="appoinment-content-text mt-0 mb-2">Por favor diligencie el nombre de la última entidad a la que se encuentra o se encontraba afiliado</p>
                                                <div class="col-md-12 my-2">
                                                    <p class="alert alert-warning p-1">Si no estas afiliado a fondo de pensiones incluye el fondo al cual deseas ser afiliado.<br><b>PORVENIR - PROTECCIÓN - COLFONDOS - COLPENSIONES - SKANDIA</b></p>
                                                </div>
                                                <div class="col-md-12 my-2">
                                                    <p class="alert alert-warning p-1">Si no estas afiliado a fondo de cesantías incluye el fondo al cual deseas ser afiliado.<br><b>PORVENIR - PROTECCIÓN - COLFONDOS - FONDO NACIONAL DEL AHORRO - SKANDIA</b></p>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label for="hvass_eps" class="form-label my-0">EPS</label>
                                                    <input type="text" class="form-control form-control-sm font-size-11 px-2 py-1" name="hvass_eps" id="hvass_eps" value="<?php echo $data['resultado_registros'][0]->hvass_eps; ?>" required autocomplete="off">
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label for="hvass_pension" class="form-label my-0">Fondo de pensión</label>
                                                    <input type="text" class="form-control form-control-sm font-size-11 px-2 py-1" name="hvass_pension" id="hvass_pension" value="<?php echo $data['resultado_registros'][0]->hvass_pension; ?>" autocomplete="off">
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label for="hvass_cesantias" class="form-label my-0">Fondo de cesantías</label>
                                                    <input type="text" class="form-control form-control-sm font-size-11 px-2 py-1" name="hvass_cesantias" id="hvass_cesantias" value="<?php echo $data['resultado_registros'][0]->hvass_cesantias; ?>" autocomplete="off">
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label for="hvass_pension_voluntario" class="form-label my-0">Fondo voluntario de pensión</label>
                                                    <input type="text" class="form-control form-control-sm font-size-11 px-2 py-1" name="hvass_pension_voluntario" id="hvass_pension_voluntario" value="<?php echo $data['resultado_registros'][0]->hvass_pension_voluntario; ?>" autocomplete="off">
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <label for="hvass_prepagada" class="form-label my-0">Medicina prepagada</label>
                                                    <input type="text" class="form-control form-control-sm font-size-11 px-2 py-1" name="hvass_prepagada" id="hvass_prepagada" value="<?php echo $data['resultado_registros'][0]->hvass_prepagada; ?>" autocomplete="off">
                                                </div>
                                                <?php endif; ?>
                                            <?php else: ?>
                                                <div class="col-md-12 my-2">
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        jQuery("#hvass_eps").on('input', function (evt) {
            jQuery(this).val(jQuery(this).val().toUpperCase());
        });
    });

    jQuery(document).ready(function(){
        jQuery("#hvass_pension").on('input', function (evt) {
            jQuery(this).val(jQuery(this).val().toUpperCase());
        });
    });

    jQuery(document).ready(function(){
        jQuery("#hvass_cesantias").on('input', function (evt) {
            jQuery(this).val(jQuery(this).val().toUpperCase());
        });
    });

    jQuery(document).ready(function(){
        jQuery("#hvass_pension_voluntario").on('input', function (evt) {
            jQuery(this).val(jQuery(this).val().toUpperCase());
        });
    });

    jQuery(document).ready(function(){
        jQuery("#hvass_prepagada").on('input', function (evt) {
            jQuery(this).val(jQuery(this).val().toUpperCase());
        });
    });

    validateControlById('hvass_eps');
    validateControlById('hvass_pension');
    validateControlById('hvass_cesantias');
    validateControlById('hvass_pension_voluntario');
    validateControlById('hvass_prepagada');
</script>
<script type="text/javascript">
    function progreso() {
        ...
        if (token!="" && id_oferta!="") {
            $.ajax({
                ...
                success: function(data){
                    ...
                    if (resp.secciones.segsocial==1) {
                        $('#btn_continuar').html('<a href="<?php echo URL; ?>seleccion-vinculacion/formulario-autorizaciones<?php echo $data['path_add']; ?>" class="btn btn-dark login-btn">Continuar</a>');
                    }
