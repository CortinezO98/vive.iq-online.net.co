                                ...
                                <div class="col-lg-12 col-md-12 col-12">
                                    <div class="row p-6 d-lg-flex justify-content-between align-items-center ">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="row mb-2">
                                                    <?php for ($i=0; $i < count($data['array_documentos']); $i++): ?>
                                                        <div class="col-12 mb-3">
                                                            <label for="<?php echo $data['array_documentos'][$i]; ?>" class="form-label my-0 font-size-11"><?php echo $data['array_documentos_nombre'][$data['array_documentos'][$i]]; ?></label>
                                                            <small class="fst-italic text-danger font-size-11">Adjunte el documento en formato PDF (Máx. 5Mb)</small>
                                                            <input type="file" class="form-control form-control-sm" name="<?php echo $data['array_documentos'][$i]; ?>" id="<?php echo $data['array_documentos'][$i]; ?>" accept=".pdf, .PDF">
                                                        </div>
                                                    <?php endfor; ?>
                                                </div>
                                            </div>
