                            ...
                            <div class="row mb-2">
                                ...
                                <div class="row">
                                    <div class="col-md-2 mb-3">
                                        <select class="form-control form-control-sm font-size-11" name="campo_1" id="campo_1" required onchange="construye_direccion();" onkeyup="construye_direccion();">
                                    ...
                                    <div class="col-md-1 mb-3">
                                        <select class="form-control form-control-sm font-size-11" name="campo_3" id="campo_3" required onchange="construye_direccion();" onkeyup="construye_direccion();">
                                            <option value=""></option>
                                    ...
                                    <div class="col-md-1 mb-3">
                                        <select class="form-control form-control-sm font-size-11" name="campo_4" id="campo_4" required onchange="construye_direccion();" onkeyup="construye_direccion();">
                                            <option value=""></option>
                                            <option value="BIS">BIS</option>
                                        </select>
                                    </div>
                                    <div class="col-md-1 mb-3">
                                        <select class="form-control form-control-sm font-size-11" name="campo_5" id="campo_5" required onchange="construye_direccion();" onkeyup="construye_direccion();">
                                            <option value=""></option>
                                            <option value="A">A</option>
                                            <option value="B">B</option>
                                            <option value="C">C</option>
                                    ...
                                    <div class="col-md-1 mb-3">
                                        <select class="form-control form-control-sm font-size-11" name="campo_6" id="campo_6" required onchange="construye_direccion();" onkeyup="construye_direccion();">
                                            <option value=""></option>
                                ...
                                <div class="row">
                                    <div class="col-md-1 mb-3">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text font-size-11 px-2 py-1" id="basic-addon1">#</span>
                                    ...
                                    <div class="col-md-1 mb-3">
                                        <select class="form-control form-control-sm font-size-11" name="campo_8" id="campo_8" required onchange="construye_direccion();" onkeyup="construye_direccion();">
                                            <option value=""></option>
                                            <option value="A">A</option>
                                            <option value="B">B</option>
                                            <option value="C">C</option>
                                    ...
                                    <div class="col-md-1 mb-3">
                                        <select class="form-control form-control-sm font-size-11" name="campo_10" id="campo_10" required onchange="construye_direccion();" onkeyup="construye_direccion();">
                                            <option value=""></option>
                                            <option value="A">A</option>
                                            <option value="B">B</option>
                                            <option value="C">C</option>
                                    ...
                                    <div class="col-md-1 mb-3">
                                        <select class="form-control form-control-sm font-size-11" name="campo_11" id="campo_11" required onchange="construye_direccion();" onkeyup="construye_direccion();">
                                            <option value=""></option>
                                            <option value="Este">Este</option>
                                            <option value="Oeste">Oeste</option>
                                            <option value="Sur">Sur</option>
                                ...
                                <div class="col-md-6 mb-3">
                                    <select class="form-control form-control-sm font-size-11" name="campo_12" id="campo_12" required onchange="construye_direccion();" onkeyup="construye_direccion();">
                                        <option value="">Seleccione</option>
