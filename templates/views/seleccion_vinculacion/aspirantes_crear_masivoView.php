                                    ...
                                    <div class="row p-6 d-lg-flex justify-content-between align-items-center ">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="row mb-2">
                                                    ...
                                                    <div class="col-12 mb-3">
                                                        ...
                                                        <input type="file" class="form-control form-control-sm" name="documento_masivo" id="documento_masivo" accept=".xls, .XLS, .xlsx, .XLSX" <?php echo ($_SESSION[APP_SESSION.'_proceso_masivo_add']==1) ? 'disabled' : ''; ?> required>
                                                    </div>
                                                    <div class="col-md-12 mb-3">
                                                        <label for="hva_observaciones" class="form-label my-0 font-size-11">Observaciones</label>
                                                        <textarea class="form-control form-control-sm" name="hva_observaciones" id="hva_observaciones" rows="3" maxlength="500" <?php echo ($_SESSION[APP_SESSION.'_proceso_masivo_add']==1) ? 'disabled' : ''; ?>><?php echo (isset($_POST["form_guardar"])) ? checkInput($_POST['hva_observaciones']) : ''; ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <?php if(count($data['resultado_registros_creados'])>0): ?>
                                                <div class="col-md-12 mb-2 mt-2">
                                                    <p class="alert alert-warning p-1">Se crearon las siguientes ofertas:</p>
                                            ...
                                            <div class="col-md-12 text-end">
                                                <?php if($_SESSION[APP_SESSION.'_proceso_masivo_add']==1): ?>
